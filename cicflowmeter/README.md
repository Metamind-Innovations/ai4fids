...
The CICFlowMeter tool has already been compiled by following [original CICFlowMeter repository](https://github.com/ahlashkari/CICFlowMeter) instructions.

# CICFlowMeter Description
